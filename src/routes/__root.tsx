...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tag Store — PlayStation Digital Games" },
      {
        name: "description",
        content: "Tag Store sells PlayStation digital games with instant delivery in Egypt.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Chakra+Petch:wght@500;600;700&family=Rubik:wght@300;400;500;600;700&display=swap",
      },
